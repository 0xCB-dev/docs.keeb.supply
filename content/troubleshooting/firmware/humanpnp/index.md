...
summary: "What is a Human PnP and how do you use it?"
...
now also available via the PCM (Plugin and Content Manager) inside KiCAD
{{< /callout >}}
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
the generated file is a HTML file - you can open it in any modern browser or upload it to a webserver
{{< /callout >}}
