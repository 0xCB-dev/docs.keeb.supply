...
The buttons in the two different versions are different! The ones in the barebones kit are shorter than the ones in the case version. On the pictures here you will only see the long ones, but yours might be short...
{{< /callout >}}
...
<br>[barebones version]({{< ref "/instructions/stress/assembly#barebones-assembly" >}})
<br>[case version]({{< ref "/instructions/stress/assembly#case-assembly" >}})
