...
Please clip off the legs of the button as short as possible. The case is designed to be as low profile as we can get so the tolerances are pretty tight.
{{< /callout >}}

#### MICROCONTROLLER

{{< callout context="note" title="Note" icon="outline/info-circle" >}}
When you buy the kit through KeebSupply you will get preflashed controllers. The controller with the yellow dot is the controller for the left side!!! Orientation is very important here!
{{< /callout >}}
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
When you buy the bluetooth version of the kit, don't forget to solder the BT- and BT+ connections!.
{{< /callout >}}
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
Please clip off the legs of the TRRS jack as short as possible. The case is designed to be as low profile as we can get so the tolerances are pretty tight.
{{< /callout >}}

<br />Once you are done with the parts for the wired version you can skip to [here]({{< ref "/instructions/totem/assembly#cleaning" >}}) to continue.
...
<br />Once you are done with the parts for the bluetooth version you can skip to [here]({{< ref "/instructions/totem/assembly#cleaning" >}}) to continue.
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
After you have cleaned the PCB it is good practice to check if your keyboard is working. Please do that now.
{{< /callout >}}

## CASE

{{< callout context="note" title="Note" icon="outline/info-circle" >}}
We're using the transparent version of the case, so it's easier to see where everything goes, but it's identical to the black/white case.
{{< /callout >}}
