...
description: "You will need these supplies to build your TOTEM!"
summary: "You will need these supplies to build your TOTEM!"
...
| -------------------------------------- | -------------- | --------------------------------------------------------------------------------------------------------------------- |
|                                        |                |                                                                                                                       |
| ![flush-cutters](flush-cutters.webp)   | flush cutters  | You will need these to clip of some metal bits from some components.                                                  |
