...
description: "These Supplies are not needed to build the TOTEM, but they definitely help!"
summary: "These Supplies are not needed to build the TOTEM, but they definitely help!"
...
| ---------------------------------- | ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|                                    |                                 |                                                                                                                                                                                                                      |
|                                    | tweezers                        | These will help putting on the small components onto the PCB.                                                                                                                                                        |
|                                    | tape/kapton tape                | This will be helpful to secure some components while soldering.                                                                                                                                                      |
