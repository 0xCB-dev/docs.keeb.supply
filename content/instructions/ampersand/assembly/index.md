...
Production model uses smaller feet than shown.
{{< /callout >}}
![Feet](5.jpg)
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
To remove the PCB, pull the top row switches towards you, putting pressure against the blockers. The top row should pop out. Alternatively, use a keycap puller to pull the plate from around the backspace switch cutout.
{{< /callout >}}
![Insert](9.jpg)
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
PCBs come preflashed with Vial compatible firmware.
{{< /callout >}}
![Vial](10.png)
