...
If you want to make the PCB look better, you can use a black sharpie to color the edges of the PCB.
{{< /callout >}}
...
If you use the [Miao]({{< ref "/instructions/miao/guide" >}}) you have to set the lower right pin to `RX` by bridging the bottom and middle pad on the left jumper pads. See [here]({{< ref "/instructions/miao/guide#pinout" >}}) for the pinout schematics.
