...
Make sure to also solder the one pin thats not on the outer edge. That pin is responsible for the RGB effects. Let solder flow through from the top until you see it coming out of the bottom.
{{< /callout >}}
