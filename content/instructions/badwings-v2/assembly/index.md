...
Make sure that the blue part of the cable faces to the text on the PCB.
{{< /callout >}}
...
{{< callout context="note" title="Note" icon="outline/info-circle" >}}
The connector on the PCB works a bit differently to the one on the Cirque. You need to lift the black bar, put the cable into the connector and push the black bar down again.
{{< /callout >}}
