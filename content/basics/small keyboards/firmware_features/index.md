...
summary: "Firmware Features That Help With Small Keyboards."
...
Usually this is used to differentiate between _taps_ (short presses with immediate release) and _holds_ (holding the key down for some time before releasing).
