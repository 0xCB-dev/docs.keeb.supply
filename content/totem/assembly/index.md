...
{{< alert icon="💡" text="When you buy the kit through KeebSupply you will get preflashed controllers. The controller with the yellow dot is the controller for the left side!!! Orientation is very important here!" />}}
